...
{	
	...
	if(request.getParameter("delete")!=null)
	{
		...
		pstmt=con.prepareStatement("delete from jenres where genre_id=? "); //sql delete query
		pstmt.setInt(1,id);
	...
	<div class="main">	
		...
		%>
				<tr>
					...
					<td><a href="http://localhost:8080/FKSTLibrary/UpdateGenre?edit=<%=rs.getInt(1)%> ">Edit</a></td>
